...
## Project Structure
    ...
    ├── applicationzaidadmi_39737  # Django project configurations
...
1. Clone this repo and `cd applicationzaidadmi_39737`
...
2. Clone this repo and `cd applicationzaidadmi_39737`
